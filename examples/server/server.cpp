...
void bark_print_usage(char **argv, const bark_server_params &params) {
...
void bark_server_params_parse(int argc, char **argv, bark_server_params &params) {
...
int main(int argc, char **argv) {
    ...
    bark_server_params params;

    bark_server_params_parse(argc, argv, params);
    ...
    svr.Post("/bark", [&](const Request &req, Response &res) {
		...
		auto audio_arr = bark_generated_audio(bctx);
		write_wav_on_disk(audio_arr, dest_wav_path.c_str());
